...
import com.griddynamics.casandra.repository.ActivityLogRepository;
...
public class ActivityLogService {
    ...
    public List<ActivityLog> getUserActivitiesInRange(UUID userId, Instant from, Instant to) {
        return activityLogPersistence.findByUserIdAndTimeRange(userId, from, to);
    }

    public List<ActivityLog> getRecentActivities(UUID userId, int limit) {
